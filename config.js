...
const MEMORY_WORKLOADS = ['memory-set-v64', 'memory-set-v64-expire', 'memory-zadd-m20', 'memory-zadd-m64', 'memory-sadd-m20', 'memory-sadd-m64', 'memory-hset-f64-v64'];
const MEMORY_USER_DATA = {
  'memory-set-v64': 80, 'memory-set-v64-expire': 80,
  'memory-zadd-m20': 28, 'memory-sadd-m20': 20,
  'memory-zadd-m64': 72, 'memory-sadd-m64': 64, 'memory-hset-f64-v64': 128,
};
